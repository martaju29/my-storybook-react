...
var MyLabel = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)("span", { className: "".concat(size, " ").concat(color, " label"), style: { color: fontColor, backgroundColor: backgroundColor }, children: allCaps ? label.toUpperCase() : label }));
};
